...
static const char __pyx_k_Incompatible_checksums_s_vs_0xc9[] = "Incompatible checksums (%s vs 0xc99d782 = (pointSet, superTetra, tetraPoints, transformed, trianglePoints, vertices))";
...
static PyObject *__pyx_int_211408770;
 ...
 */
    ...
    if ((likely(PyTuple_CheckExact(__pyx_t_1))) || (PyList_CheckExact(__pyx_t_1))) {
      ...
      index = 0; __pyx_t_7 = __pyx_t_13(__pyx_t_4); if (unlikely(!__pyx_t_7)) goto __pyx_L8_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_7);
 ...
 * 
 */
  __pyx_t_2 = PySet_New(__pyx_v_vertB); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 117, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_intersection); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 117, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PySet_New(__pyx_v_vertA); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 117, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (!(likely(PySet_CheckExact(__pyx_t_1))||((__pyx_t_1) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "set", Py_TYPE(__pyx_t_1)->tp_name), 0))) __PYX_ERR(0, 117, __pyx_L1_error)
 ...
 */
  ...
  for (;;) {
    ...
    __Pyx_GOTREF(__pyx_t_3);
    #endif
    if (!(likely(((__pyx_t_3) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_3, __pyx_ptype_5Tetra_Tetrahedron))))) __PYX_ERR(0, 131, __pyx_L1_error)
 ...
 *     state = (self.pointSet, self.superTetra, self.tetraPoints, self.transformed, self.trianglePoints, self.vertices)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_v_self->pointSet);
  __Pyx_INCREF(((PyObject *)__pyx_v_self->superTetra));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_self->superTetra));
  PyTuple_SET_ITEM(__pyx_t_1, 1, ((PyObject *)__pyx_v_self->superTetra));
  __Pyx_INCREF(__pyx_v_self->tetraPoints);
  __Pyx_GIVEREF(__pyx_v_self->tetraPoints);
  PyTuple_SET_ITEM(__pyx_t_1, 2, __pyx_v_self->tetraPoints);
  __Pyx_INCREF(__pyx_v_self->transformed);
  __Pyx_GIVEREF(__pyx_v_self->transformed);
  PyTuple_SET_ITEM(__pyx_t_1, 3, __pyx_v_self->transformed);
  __Pyx_INCREF(__pyx_v_self->trianglePoints);
  __Pyx_GIVEREF(__pyx_v_self->trianglePoints);
  PyTuple_SET_ITEM(__pyx_t_1, 4, __pyx_v_self->trianglePoints);
  __Pyx_INCREF(__pyx_v_self->vertices);
  __Pyx_GIVEREF(__pyx_v_self->vertices);
  PyTuple_SET_ITEM(__pyx_t_1, 5, __pyx_v_self->vertices);
 ...
 *         use_setstate = True             # <<<<<<<<<<<<<<
 *     else:
 *         use_setstate = self.pointSet is not None or self.superTetra is not None or self.tetraPoints is not None or self.transformed is not None or self.trianglePoints is not None or self.vertices is not None
 */
 ...
 *         use_setstate = self.pointSet is not None or self.superTetra is not None or self.tetraPoints is not None or self.transformed is not None or self.trianglePoints is not None or self.vertices is not None             # <<<<<<<<<<<<<<
 *     if use_setstate:
 *         return __pyx_unpickle_Delaunay, (type(self), 0xc99d782, None), state
 */
  /*else*/ {
 ...
 *         return __pyx_unpickle_Delaunay, (type(self), 0xc99d782, None), state             # <<<<<<<<<<<<<<
 *     else:
 *         return __pyx_unpickle_Delaunay, (type(self), 0xc99d782, state)
 */
    __Pyx_XDECREF(__pyx_r);
    ...
    __Pyx_INCREF(__pyx_int_211408770);
    __Pyx_GIVEREF(__pyx_int_211408770);
    PyTuple_SET_ITEM(__pyx_t_1, 1, __pyx_int_211408770);
    __Pyx_INCREF(Py_None);
    __Pyx_GIVEREF(Py_None);
 ...
 *     cdef object __pyx_PickleError
 *     cdef object __pyx_result
 *     if __pyx_checksum != 0xc99d782:             # <<<<<<<<<<<<<<
 *         from pickle import PickleError as __pyx_PickleError
 *         raise __pyx_PickleError("Incompatible checksums (%s vs 0xc99d782 = (pointSet, superTetra, tetraPoints, transformed, trianglePoints, vertices))" % __pyx_checksum)
 */
  __pyx_t_1 = ((__pyx_v___pyx_checksum != 0xc99d782) != 0);
  if (__pyx_t_1) {
 ...
 *     return __pyx_result             # <<<<<<<<<<<<<<
 * cdef __pyx_unpickle_Delaunay__set_state(Delaunay __pyx_result, tuple __pyx_state):
 *     __pyx_result.pointSet = __pyx_state[0]; __pyx_result.superTetra = __pyx_state[1]; __pyx_result.tetraPoints = __pyx_state[2]; __pyx_result.transformed = __pyx_state[3]; __pyx_result.trianglePoints = __pyx_state[4]; __pyx_result.vertices = __pyx_state[5]
 */
  __Pyx_XDECREF(__pyx_r);
...
static CYTHON_SMALL_CODE int __Pyx_InitGlobals(void) {
  ...
  __pyx_int_211408770 = PyInt_FromLong(211408770L); if (unlikely(!__pyx_int_211408770)) __PYX_ERR(0, 1, __pyx_L1_error)
  return 0;
  __pyx_L1_error:;
  return -1;
}
